...
# SEC Floating Feature configuration file for Galaxy A50 (a50)
...
# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A50
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=3
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A505F
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a50_sdm675
