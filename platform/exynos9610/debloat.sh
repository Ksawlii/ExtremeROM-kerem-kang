...
# Debloat list for Galaxy A50 (a50) - Exynos 9610
# - Add entries inside the specific partition containing that file (<PARTITION>_DEBLOAT+="")
# - DO NOT add the partition name at the start of any entry (eg. "/system/dpolicy_system")
# - DO NOT add a slash at the start of any entry (eg. "/dpolicy_system")

# Camera SDK (AI özellikleri desteklenmiyor, güvenle temizlenebilir)
SYSTEM_DEBLOAT+="
...
# Wi-Fi Hotspot Overlay’leri (A50’de 6GHz, OWE veya Dual-AP desteklenmez)
PRODUCT_DEBLOAT+="
...
# StorageShare (kSMBd) - A50'de kullanıcılara sunulmaz, temizlenebilir
SYSTEM_DEBLOAT+="
