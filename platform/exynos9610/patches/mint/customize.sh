# [
MINT_REPO="https://github.com/longuirom/android_kernel_samsung_exynos9610_mint"
...
BUILD_KERNEL()
{
    ...
    ./build.sh -d ${TARGET_CODENAME} -a 12 -v oneui -k -p
...
REPLACE_KERNEL_BINARIES()
{
    ...
    echo "Cloning/updating MintKernel"
